      ...
      sections: [
        {
          ...
          content: {
            international_context: {
              favorable:
                "Dân tộc là cộng đồng người ổn định, hình thành trong lịch sử, có chung lãnh thổ, ngôn ngữ, đời sống kinh tế, nền văn hoá và tâm lý.",
              challenges: [
                "Thị tộc",
                "Bộ lạc",
                "Bộ tộc",
            ...
            domestic_context: {
              west :
                "Dân tộc xuất hiện khi phương thức sản xuát tư bản chủ nghĩa được xác lập thay thế phương thức sản xuất phong kiến.",
              east:
                "Dân tộc được hình thanh trên cơ sở một nền văn hoá, một tâm lý dân tộc đã phát triển tương đối chính muồi và một cộng đồng kinh tế tuy đã đạt tới một mức độ nhất định song nhìn chung còn kém phát triển và ở trạng thái phân tán.",
              mean_1: {
                first: "Có chung phương thức sinh hoạt kinh tế.",
                second: "Có lãnh thổ chung ổn định không bị chia cắt, là địa bàn sinh tồn và phát triển của cộng đồng dân tộc.",
                third: "Có sự quản lý của một nhà nước, nhà nước - dân tộc độc lập.",
                fourth: "Có ngôn ngữ chung của quốc gia làm công cụ giao tiếp trong xã hội và trong cộng đồng.",
                fifth: "Có nét tâm lý biểu hiện qua nền văn hoá dân tộc và tạo nên bản sắc riêng của nền văn hoá dân tộc."
              },
              mean_2: {
                first: "Cộng đồng về ngôn ngữ (bao gồm ngôn ngữ nói, ngôn ngữ viết; hoặc chỉ riêng ngôn ngữ nói).",
                second: "Cộng đồng về văn hoá.",
                third: "Ý thức tự giác tộc người.",
              },
            },
          },
        },
      ...
      sections: [
        {
          ...
          content: {
            key_decisions: {
              basic_mission:
                "Chủ nghĩa Mác - Lênin cho rằng tôn giáo:",
            }
          },
        },
        {
